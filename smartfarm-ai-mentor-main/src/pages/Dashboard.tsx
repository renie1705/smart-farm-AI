...
import { Cloud, Droplets, Sun, ThermometerSun, MapPin, Loader2, TrendingUp, Radio, TrendingDown, Globe, IndianRupee } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted">
      ...
      <section className="container py-12">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="bg-gradient-to-br from-accent/10 to-accent/5 border-accent/20 hover:shadow-lg transition-all cursor-pointer group">
            <CardHeader>
